...
void Application::InitVariables(void)
{
	...
	m_stopsList.push_back(vector3(3.0f, 5.0f, 0.0f)); //wasn't sure what the assignment actually was...
	m_stopsList.push_back(vector3(-3.0f, -5.0f, 0.0f)); //so i added some extra stops just to change something...
